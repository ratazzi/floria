...
mod tests {
    ...
    fn secret_validation_applies_codec_and_surface_constraints() {
        ...
        let snapshot = CatalogSnapshot {
            ...
            bindings: vec![accessfs_catalog::Binding {
                id: "fixture-binding".to_string(),
                project_id: "fixture-project".to_string(),
                scope: accessfs_catalog::BindingScope::Common,
                resource_id: "fixture-line".to_string(),
                selection: accessfs_catalog::EntrySelection::All,
                key_override: None,
                enabled: true,
                allow_override: false,
                position: 0,
            }],
            surfaces: vec![accessfs_catalog::Surface {
