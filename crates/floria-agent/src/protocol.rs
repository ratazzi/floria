...
use floria_core::authz::{AccessContext, PolicyEvaluation};
...
mod tests {
    ...
    fn prompt_wire_shape_includes_operation() {
        ...
        id.parent_chain = vec![
            floria_core::identity::ProcSummary {
                pid: 7,
                ppid: 6,
                name: "cat".to_string(),
    ...
    fn ssh_sign_view_includes_requested_and_verified_session_context() {
        let context = AccessContext::SshSign(floria_core::authz::SshSignContext {
